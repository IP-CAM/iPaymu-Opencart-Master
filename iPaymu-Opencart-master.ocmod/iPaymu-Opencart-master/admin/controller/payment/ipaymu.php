...
class ControllerPaymentIpaymu extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/payment', 'token=' . $this->session->data['token'], 'SSH'));
		}
		...
		$data['entry_virtual_account'] = $this->language->get('entry_virtual_account');
		...
		$data['button_cancel'] = $this->language->get('button_cancel');
 		...
 		if (isset($this->error['virtual_account'])) {
			$data['virtual_account'] = $this->error['virtual_account'];
		} else {
			$data['error_virtual_account'] = '';
		}

 		if (isset($this->error['inv_virtual_account'])) {
			$data['error_inv_virtual_account'] = $this->error['inv_virtual_account'];
		} else {
			$data['error_inv_virtual_account'] = '';
		}
		...
		if (isset($this->request->post['ipaymu_virtual_account'])) {
			$data['ipaymu_virtual_account'] = $this->request->post['ipaymu_virtual_account'];
		} else {
			$data['ipaymu_virtual_account'] = $this->config->get('ipaymu_virtual_account');
		}
		...
		if (isset($this->request->post['ipaymu_inv_virtual_account'])) {
			$data['ipaymu_inv_virtual_account'] = $this->request->post['ipaymu_inv_virtual_account'];
		} else {
			$data['ipaymu_inv_virtual_account'] = $this->config->get('ipaymu_inv_virtual_account');
		}
